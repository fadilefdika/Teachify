...
import { ArrowLeft, Camera, Shield, Mail, Phone, MapPin, Calendar, Edit } from 'lucide-react'; // import ikon dari lucide-react
      ...
      <header className="flex h-16 items-center gap-2 bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl border-b border-white/20 dark:border-gray-800/20">
        <div className="flex items-center gap-2 px-4 flex-1">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem className="hidden md:block">
                <BreadcrumbLink href="#" onClick={handleBack} className="text-blue-600 hover:text-blue-700">
                  Admin Dashboard
                </BreadcrumbLink>
              </BreadcrumbItem>
          ...
          <div className="ml-auto">
            <Button variant="outline" onClick={handleBack} className="rounded-xl border-violet-200 hover:bg-violet-50 dark:border-violet-800 dark:hover:bg-violet-900/20">
